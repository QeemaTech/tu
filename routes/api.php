...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('delivery')->middleware('delivery.user')->group(function () {
            ...
            Route::get('orders', [DeliveryController::class, 'ordersReady'])->name('api.delivery.orders-ready');
            Route::get('orders/{order}', [DeliveryController::class, 'showOrderReady'])->name('api.delivery.orders-ready.show');
